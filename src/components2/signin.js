    ...
    return (
        <div className='signin-container'>
            <div className='signin-header'>
                <div className='signup'><Link to='/signup'>ثبت نام<RiDoorOpenLine/></Link></div>
                <div className='home'><Link to='/'> نماوا</Link></div>
            ...
            <div className='signin-box'>
                ...
                <div className='phone-no'>
                    ...
                    <div className='input'>
                        <input type="password"  onBlur={()=>{setIsActive(false)}} onFocus={() => {setIsActive(true) }}/>
                    </div>
